...
export type FetchRecipesSearchStart = Action<RECIPES_SEARCH_ACTION_TYPES.FETCH_RECIPE_SEARCH_START>;
...
export const fetchRecipesSearchStart = withMatcher(() : FetchRecipesSearchStart => createAction(RECIPES_SEARCH_ACTION_TYPES.FETCH_RECIPE_SEARCH_START));
